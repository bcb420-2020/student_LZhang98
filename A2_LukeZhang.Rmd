...
The results of querying downregulated genes are extremely interesting, as almost all results have been lost except for a single term from GO:BP and 2 more terms from WikiPathways. This implies that downregulation on its own is not a significant measure by which to analyze the genesets, and that
