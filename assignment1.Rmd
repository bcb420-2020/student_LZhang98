...
zeroes
```
Each element of this vector is the number of zero counts for each of the D1 samples. We see that they total to 7 outliers.
...
I noticed 7 outliers in my data (the sets of zero-counts in 5 out of 6 D1 samples). I didn't remove any because I felt that their presence was too consistent across one group to simply be measurement error.
